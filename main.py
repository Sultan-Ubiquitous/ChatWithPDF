...
if api_key:
    llm = ChatGroq(api_key=api_key, model_name="mistral-saba-24b")
    ...
    if uploaded_files:
        ...
        contextualize_q_system_prompt = (
            ...
            "formulate a standalone question which cannot be understood "
        ...
        if user_input:
            ...
            # st.write("Chat History:", session_history.messages)  # Optional: show chat history
